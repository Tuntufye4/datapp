    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : errorMessage != null
              ...
              : districtCases.isEmpty && diseaseCounts.isEmpty
                                    ...
                                    child: BarChart(
                                      BarChartData(
                                        barGroups: districtCases.keys
                                          ...
                                          final count = districtCases[district]!
                                              .toDouble();
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: PieChart(
                                      PieChartData(
                                        sections: diseaseCounts.keys
                                            .toList()
                                            .map((disease) {
                                          final count =
                                              diseaseCounts[disease]!.toDouble();
                                          final totalCases = diseaseCounts.values
                                              .fold<int>(0, (a, b) => a + b);
                                          final percentage =
                                  ...
                                  Wrap(
                                    ...
                                    runSpacing: 4,
                                    children:
                                        diseaseCounts.keys.map((disease) {
                                      final color = Colors.primaries[
                                          diseaseCounts.keys
                                                  .toList()
                                                  .indexOf(disease) %
